...
public class CreateDatabase extends Command {
    ...
    public CreateDatabase(DatabaseService databaseService,
    ...
    public Object execute(Request request) {
        ...
        Response response = databaseService.createDatabase(databaseName);
        if (request instanceof UserRequest)
            syncWithAllNodes(Operation.CREATE_DATABASE, request.getData(), null, null, response);
